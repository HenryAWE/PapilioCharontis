...
namespace papilio
{
    ...
    template <typename OutputIt>
    format_to_n_result<OutputIt> vformat_to_n(OutputIt out, std::iter_difference_t<OutputIt> n, std::string_view fmt, const dynamic_format_arg_store& store)
    {
    ...
    template <typename OutputIt>
    format_to_n_result<OutputIt> vformat_to_n(OutputIt out, std::iter_difference_t<OutputIt> n, const std::locale& loc, std::string_view fmt, const dynamic_format_arg_store& store)
    {
        auto result = vformat_to(
            detail::format_to_n_wrapper<OutputIt>(out, n),
            loc,
